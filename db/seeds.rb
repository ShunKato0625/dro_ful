...
Post.create!(
  [
    ...
    prefecture_id: '14', drone_type: 'DJI-AIR 2S', authorization: '湘南海上保安署(0466-00-0000)FAXで飛行計画書必要。藤沢警察署(0466-00-0000)', rate: '4.0', customer_id: '1',lat: '35.30624402851759', lng: '139.49247112760006',
    ...
    prefecture_id: '14', drone_type: 'DJI-AIR 2S', authorization: '三崎警察署(0466-00-0000)', rate: '3.5', customer_id: '1',lat: '35.1342601', lng: '139.6209837',
    ...
    prefecture_id: '14', drone_type: 'DJI-AIR 2S', authorization: '三保ダム周辺は神奈川県公式HPでドローンが使用できる記載がある。法令遵守必須。', rate: '4.0', customer_id: '1',lat: '35.4134806513101', lng: '139.04279648203126',
    ...
    prefecture_id: '14', drone_type: 'DJI-AIR 2S', authorization: '神奈川県立真鶴半島自然公園(0460-00-0000)', rate: '3.0', customer_id: '1',lat: '35.141110401869255', lng: '139.1597824190185',
    ...
    prefecture_id: '14', drone_type: 'DJI-AIR 2S', authorization: '環境政策部公園管理科', rate: '3.0', customer_id: '2',lat: '35.2409485', lng: '139.5978061',
    ...
    prefecture_id: '12', drone_type: 'DJI-AIR 2S', authorization: '屏風ヶ浦崖上を飛行する場合は私有地の為、管理会社：株式会社◯◯(0479-00-0000)に連絡が必要。遊歩道を飛行する場合は千葉県銚子土木事務所管理用地課(0479-00-0000)に連絡が必要。海上は特に許可取りは必要ない。', rate: '4.0', customer_id: '9',lat: '35.693103809584215', lng: '140.7440359',
    ...
    prefecture_id: '12', drone_type: 'DJI-AIR 2S', authorization: '小湊鐵道養老渓谷駅(0436-00-0000)電車と近距離で撮影したい場合は一報入れる。禁止はされていない。', rate: '4.5', customer_id: '2',lat: '35.27059896157172', lng: '140.15455221895755',
    ...
    prefecture_id: '12', drone_type: 'DJI-AIR 2S', authorization: '特にドローン規制はないので法令遵守。鴨川警察署に連絡入れると良い。(04-0000-0000)', rate: '3', customer_id: '3',lat: '35.0893883', lng: '140.0988669',
    ...
    prefecture_id: '12', drone_type: 'DJI-AIR 2S', authorization: '富津公園管理事務所', rate: '2.5', customer_id: '4',lat: '35.31254612606333', lng: '139.78543675239257',
    ...
    prefecture_id: '11', drone_type: 'DJI-AIR 2S', authorization: '滝沢ダム湖上空は飛行可能。ダム施設からの離発着は禁止。長瀞荒川は長瀞町に相談、届出すると協力を受けることができる。', rate: '3.5', customer_id: '14',lat: '35.956931536814764', lng: '138.89901155291747',
    ...
    prefecture_id: '11', drone_type: 'DJI-AIR 2S', authorization: '埼玉県土整備部　県土整備政策課（048-000-0000）', rate: '3.5', customer_id: '2',lat: '35.91128717484222', lng: '138.8219143227539',
    ...
    prefecture_id: '8', drone_type: 'DJI-AIR 2S', authorization: '磯前神社の鳥居をくぐらせたり、近くを飛行したい場合は大洗磯前神社に電話連絡で確認。（029-000-0000）', rate: '4.0', customer_id: '5',lat: '36.315155680084274', lng: '140.5891144619019',
    ...
    prefecture_id: '22', drone_type: 'DJI-AIR 2S', authorization: '熱海市役所維持管理室(0557-00-0000)。熱海警察署中央交(0557-00-0000)', rate: '3.0', customer_id: '3',lat: '35.09891767748371', lng: '139.07757757147218',
    ...
    prefecture_id: '22', drone_type: 'DJI-AIR 2S', authorization: '海水浴場は海開き期間中以外は禁止されていない。石廊崎は下田海上保安部管理課に連絡。（0558-00-0000）', rate: '3.0', customer_id: '4',lat: '34.67552320992074', lng: '138.9537289688477',
    ...
    prefecture_id: '22', drone_type: 'DJI-AIR 2S', authorization: '大井川鐵道・長島ダム。', rate: '4.0', customer_id: '1',lat: '35.1679501', lng: '138.1810878',
    ...
    prefecture_id: '22', drone_type: 'DJI-AIR 2S', authorization: '三島スカイウォーク', rate: '4', customer_id: '4',lat: '35.15290870238291', lng: '138.98009508518066',
    ...
    prefecture_id: '10', drone_type: 'DJI-AIR 2S', authorization: '沼田市観光協会', rate: '3.5', customer_id: '2',lat: '36.7022355', lng: '139.2073279',
    ...
    prefecture_id: '9', drone_type: 'DJI-AIR 2S', authorization: '日光湯元ビジターセンター', rate: '3', customer_id: '6',lat: '36.796410140427625', lng: '139.4292978645874',
    ...
    prefecture_id: '13', drone_type: 'DJI Mavic Air 2', authorization: '土地の所有者、管理者。所轄警察への飛行通達', rate: '3', customer_id: '7',lat: '35.6575361', lng: '139.7063444',
